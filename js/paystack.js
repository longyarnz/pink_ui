!function () {
  ...
  Inline.prototype.setTransaction = function (t) {
    this.defaults && this.resetNewCheckout(),
      ...
      this.isEmbed ? (this.removeNewCheckout(),
        this.setupEmbed()) : this.updateIframe()
  }
    ,
    ...
    Inline.prototype.loadButtonCSS = function () {
      var t = this;
      cssLoad(config.siteUrl + "public/css/button.min.css").done(function () {
        t.loadedButtonCSS = !0
      })
    }
    ,
    Inline.prototype.createButton = function () {
      var t, e = this;
      e.defaults.customButton ? (t = document.getElementById(e.defaults.customButton)).setAttribute("data-paystack", e.defaults.id) : ((t = document.createElement("button")).innerHTML = "<span class='paystack-top-blue'>Pay Securely with Paystack</span><span class='paystack-body-image'> </span>",
        t.setAttribute("class", "paystack-trigger-btn"),
        t.setAttribute("data-paystack", e.defaults.id),
        sourceScript.parentNode.insertBefore(t, sourceScript.nextSibling)),
    ...
    Inline.prototype.setup = function () {
      this.isEmbed ? this.setupEmbed() : this.setupNewPopup(),
        this.loadedButtonCSS || this.loadButtonCSS()
    }
    ,
    Inline.prototype.setupEmbed = function () {
      ...
      t.innerHTML = "",
        ...
        t.className = "paystack-embed-container",
        ...
        this.isSetup = !0,
        this.openOldCheckout()
    }
    ,
    Inline.prototype.setupOldPopup = function () {
      var t = 10 * findHighestZIndex("div")
        , e = "z-index: " + Math.max(t, 999999);
    ...
    Inline.prototype.getTransactionParameters = function () {
      ...
      return t.mode = "popup",
        t.hasTLSFallback = null !== this.defaults.tlsFallback,
        t.metadata && "string" != typeof t.metadata && (t.metadata = JSON.stringify(t.metadata)),
        void 0 !== t.card && -1 < ["false", !1].indexOf(t.card) && (t.channels = ["bank"],
          delete t.card),
        void 0 !== t.bank && -1 < ["false", !1].indexOf(t.bank) && (t.channels = ["card"],
          delete t.bank),
        t
    }
    ,
    Inline.prototype.getOldCheckoutURL = function () {
      var t = config.siteUrl + "assets/payment/production/inline.html"
        , e = this.getTransactionParameters();
      return e && (t = t + "?" + serialize(e)),
        t
    }
    ,
    Inline.prototype.appendIframe = function (t) {
      ...
      iframe = document.createElement("iframe"),
        ...
        iframe.style.cssText = t.cssText,
        iframe.id = iframe.name = e.defaults.id,
        iframe.src = t.src,
        iframe.className = t.className,
    ...
    Inline.prototype.updateIframe = function () {
      var t = this.getTransactionParameters()
        , e = t ? "newTransaction" : "popup";
    ...
    Inline.prototype.listenForEvents = function () {
      ...
      eventer(messageEvent, function (t) {
        e.checkoutRemoved || (e.isEmbed ? e.handleOldCheckoutEvents(t) : e.handleNewCheckoutEvents(t))
      }, !1)
    }
    ,
    Inline.prototype.handleOldCheckoutEvents = function (t) {
      ...
      if (n && ("string" == typeof n || n instanceof String)) {
        var r = parseResponse(n, e.defaults)
          , i = r.isThisIframe && "PaystackClose" === r.action
          , a = "close" === r.action;
        if (i || a) {
          var o = r.data;
          e.isEmbed || e.closeOldCheckout(),
            o ? e.handleSuccess(JSON.parse(o)) : e.defaults.onClose && e.callCloseCallback()
        }
        "PaystackTLSClose" == r.action && (e.defaults.tlsFallback.call(this),
          e.isEmbed || e.closeOldCheckout())
      }
    }
    ,
    Inline.prototype.listenForResizeEvent = function () {
      ...
      eventer(messageEvent, function (t) {
        ...
        if (e && ("string" == typeof e || e instanceof String)) {
          ...
          if (!n.isThisIframe || "PaystackResize" != n.action)
            return;
    ...
    Inline.prototype.openOldCheckout = function () {
      ...
      if (!this.iframeOpen) {
        var t = function () {
          ...
          t.contentWindow.postMessage("PaystackOpen " + e.defaults.id, "*"),
            e.isEmbed || (t.style.display = "block",
    ...
    Inline.prototype.openNewCheckout = function () {
      !this.iframe || this.isIframeOpen || this.isEmbed || (this.background.style.display = "",
        this.background.style.visibility = "visible",
        this.iframe.style.display = "",
        this.iframe.contentWindow.postMessage("render", "*"),
        this.isIframeOpen = !0)
    }
    ,
    Inline.prototype.removeLoader = function () {
      this.iframe.style.visibility = "visible",
        this.background.contentWindow.document.getElementById("app-loader").style.display = "none"
    }
    ,
    Inline.prototype.handleNewCheckoutEvents = function (t) {
      if (t.origin + "/" === config.newCheckoutUrl && this.iframe.contentWindow == t.source) {
        var e = t.data || t.message;
        if ("loaded:checkout" === e && (this.checkoutLoaded = !0,
          this.defaults && this.updateIframe()),
          "loaded:transaction" === e && this.removeLoader(),
          "close" === e) {
          if (this.closeNewCheckout(),
        ...
        try {
          var n = JSON.parse(e);
          n && "success" === n.status && (this.closeNewCheckout(!0),
    ...
    Inline.prototype.closeNewCheckout = function (t) {
      var e = this;
      e.background.style.opacity = 0,
        e.iframe.style.display = "none",
        e.iframe.contentWindow.postMessage("close", "*"),
        e.isIframeOpen = !1,
        setTimeout(function () {
    ...
    Inline.prototype.resetBackgroundAndLoader = function () {
      this.background.style.display = "none",
        ...
        this.background.contentWindow.document.getElementById("app-loader").style.display = "block"
    }
    ,
    Inline.prototype.removeNewCheckout = function () {
      this.iframe.parentElement.removeChild(this.iframe),
        ...
        this.iframe = null,
        this.background = null,
        this.checkoutRemoved = !0
    }
    ,
    Inline.prototype.handleSuccess = function (t) {
      var e;
      if (this.defaults.callback || this.form)
        return this.form ? ((e = document.createElement("input")).type = "hidden",
          e.value = t.reference,
          e.name = "reference",
          this.form.appendChild(e),
          (e = document.createElement("input")).type = "hidden",
          e.value = t.reference,
          e.name = "paystack-trxref",
          this.form.appendChild(e),
          void this.form.submit()) : void (this.defaults.callback && this.defaults.callback.call(this, t))
    }
    ,
  ...
  var PaystackPop = {
    ...
    setup: function (t, e) {
      ...
      if (isValid(r)) {
        if (this.isInitialized ? ca.setTransaction(r) : this.initialize(r),
          !e)
          return ca;
        checkForParentForm(e),
          ca.setForm(getParentForm(e)),
          window[n] = ca
      }
    }
  }, ca;
  window.PaystackPop = PaystackPop,
    ...
    ;
  var sourceScript = document.currentScript || (ia = document.getElementsByTagName("script"),
    ia[ia.length - 1]), ia;
  ...
  function isValid(t) {
    if (validateInputTypes(t),
      null == t.key)
      throw new Error("Please provide your public key via the key attribute");
    if (null == t.amount && null == t.plan)
      throw new Error("Please provide transaction amount via the amount or plan attribute");
    if (null == t.email && null == t.customer_code)
      throw new Error("Please provide customer email via the email or customerCode attribute");
    if (t.transaction_charge && t.transaction_charge >= t.amount)
      throw new Error("Transaction charge must be less than the transaction amount");
    ...
    if (t.customButton && null != t.customButton && null == document.getElementById(t.customButton))
      throw new Error("Please ensure a button with id " + t.customButton + " is defined");
    if (t.container && null != t.container && null == document.getElementById(t.container))
      throw new Error("Please ensure an element with id " + t.container + " is defined");
    return !0
  }
  ...
  function noBrowserIframeSupport() {
    ...
    return t || console.warn("This browser does not support iframes. Please redirect to standard"),
      !t
  }
  function parseResponse(t, e) {
    var n, r, i, a, o;
    return "string" == typeof t && (n = t.split(" ")[0]),
      n && (i = (r = t.split(" "))[1],
        a = r.slice(2).join(" "),
        o = e.id == i),
      {
  ...
  function omitKeys(t, e) {
    for (var n = JSON.parse(JSON.stringify(t)), r = 0; r < e.length; r++)
      delete n[e[r]];
    for (var i in n)
      n.hasOwnProperty(i) && !n[i] && delete n[i];
    return n
  }
  ...
  function cssLoad(t, e) {
    ...
    return u.setAttribute("id", r),
      ...
      void 0 !== u.addEventListener ? (u.addEventListener("load", d, !1),
        u.addEventListener("error", l, !1)) : void 0 !== u.attachEvent && u.attachEvent("onload", function () {
          var t, e = document.styleSheets.length;
          try {
            for (; e--;)
              if ((t = document.styleSheets[e]).id === r)
                return t.cssText,
                  void d()
          } catch (t) { }
          s || l()
  ...
  function (t) {
        ...
        t.fetch = function (n, i) {
          return new Promise(function (r, t) {
            ...
            a.onload = function () {
              ...
              "include" === e.credentials ? a.withCredentials = !0 : "omit" === e.credentials && (a.withCredentials = !1),
    ...
    function f(e) {
      this.map = {},
        e instanceof f ? e.forEach(function (t, e) {
          this.append(e, t)
      ...
      return this.bodyUsed = !1,
        this._initBody = function (t) {
          if (this._bodyInit = t)
            if ("string" == typeof t)
              this._bodyText = t;
            else if (o && Blob.prototype.isPrototypeOf(t))
              this._bodyBlob = t;
      ...
      0 !== n._state ? (n._handled = !0,
        a._immediateFn(function () {
          ...
          if (null !== t) {
            ...
            (1 === n._state ? o : s)(r.promise, n._value)
        })) : n._deferreds.push(r)
    }
    function o(e, t) {
      try {
